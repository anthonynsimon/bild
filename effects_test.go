	...
	cases := []struct {
	...
	}{
		{
			...
			expected: &image.RGBA{
				...
				Stride: 3 * 4,
				Pix: []uint8{
					0x00, 0x00, 0x00, 0xff, 0x40, 0x40, 0x40, 0xff, 0xff, 0xff, 0xff, 0xff,
	...
	cases := []struct {
	...
	}{
		{
			...
			expected: &image.RGBA{
				...
				Stride: 3 * 4,
				Pix: []uint8{
					0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x1, 0x1, 0x1, 0x80,
					0x00, 0x00, 0x00, 0xff, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00,
					0x80, 0x80, 0x80, 0x80, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00,
				},
			},
		},
		{
			...
			expected: &image.RGBA{
				...
				Stride: 3 * 4,
				Pix: []uint8{
					0x80, 0x80, 0x80, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x80,
					0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x80, 0xff, 0xff, 0xff, 0x0,
					0xff, 0xff, 0xff, 0x80, 0x80, 0x80, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0,
				},
			},
		},
	}
