...
func TestResizeGaussian(t *testing.T) {
	...
	for _, c := range cases {
		...
		if !rgbaImageEqual(actual, c.expected) {
			t.Error(testFailMessage("ResizeGaussian "+c.name, formatImageString(c.expected), formatImageString(actual)))
		}
	}
}
...
func TestResizeCatmullRom(t *testing.T) {
	...
	for _, c := range cases {
		...
		if !rgbaImageEqual(actual, c.expected) {
			t.Error(testFailMessage("ResizeCatmullRom "+c.name, formatImageString(c.expected), formatImageString(actual)))
		}
	}
}
...
func TestResizeMitchell(t *testing.T) {
	...
	for _, c := range cases {
		...
		if !rgbaImageEqual(actual, c.expected) {
			t.Error(testFailMessage("ResizeMitchell "+c.name, formatImageString(c.expected), formatImageString(actual)))
		}
	}
}
...
func TestResizeLanczos(t *testing.T) {
	...
	for _, c := range cases {
		...
		if !rgbaImageEqual(actual, c.expected) {
			t.Error(testFailMessage("ResizeLanczos "+c.name, formatImageString(c.expected), formatImageString(actual)))
		}
	}
}
