...
func TestHistogramMin(t *testing.T) {
	...
	for _, c := range cases {
		...
		if actual != c.expected {
			t.Error(testFailMessage("HistogramMin", c.expected, actual))
		}
	}
}
...
func TestHistogramMax(t *testing.T) {
	...
	for _, c := range cases {
		actual := c.hist.Max()
		if actual != c.expected {
			t.Error(testFailMessage("HistogramMax", c.expected, actual))
		}
	}
}
...
func TestHistogramCumulative(t *testing.T) {
	...
	for _, c := range cases {
		...
		if !histogramBinsEqual(actual.Bins, c.expected.Bins) {
			t.Error(testFailMessage("HistogramCumulative", c.expected, actual))
		}
	}
}
...
func TestHistogramImage(t *testing.T) {
	...
	for _, c := range cases {
		...
		if !grayscaleImageEqual(actual, c.expected) {
			t.Error(testFailMessage("HistogramImage", formatImageGrayString(c.expected), formatImageGrayString(actual)))
		}
	}
}
...
func TestNewRGBAHistogram(t *testing.T) {
	...
	for _, c := range cases {
		...
		if !rgbaHistogramEqual(actual, &c.expected) {
			t.Error(testFailMessage("NewRGBAHistogram", c.expected, actual))
		}
	}
}
...
func TestRGBAHistogramCumulative(t *testing.T) {
	...
	for _, c := range cases {
		actual := c.hist.Cumulative()
		if !rgbaHistogramEqual(actual, &c.expected) {
			t.Error(testFailMessage("RGBAHistogramCumulative", c.expected, actual))
		}
	}
}
